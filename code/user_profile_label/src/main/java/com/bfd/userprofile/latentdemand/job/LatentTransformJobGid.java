...
import com.bfd.userprofile.latentdemand.mr.LatentTransformReducerGid;
import com.bfd.userprofile.latentdemand.writable.LabelPointWritable;

public class LatentTransformJobGid extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new LatentTransformJobGid(), args));
	}
